...
<meta http-equiv="refresh" content="1;url=userAction-getUserUpdate?iid=${ session_user.userId }" />
<title>跳转中...</title>
<!-- load stylesheets -->
<!-- <link rel="stylesheet"
		...
		<table width="600" height="84" border="0" align="center">
			<tr>
				<td style="font-size: 50px;">
					<s:text name=":)" /></br>
					<span>${ updateUserResult}</span>
				</td>
			</tr>
			<tr>
				<td>
				 	<s:text name="服务器正在加载数据。。。如果 10 秒内没有成功加载请" />&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="userAction-getUserUpdate?iid=${ session_user.userId }">点击此处立即跳转</a>
				</td>
			</tr>
		</table>
	</div>
